...
namespace M.B.N.G.B.T.RavenTest_IQ
{
    ...
    public partial class RavenTestIQViewUserErrorsPage : Page, INewRavenTestIQViewUserErrorsPage
    {
        ...
        private List<List<Image>> listPics_PicErrorChecked_6_And_8 = new List<List<Image>>();
        ...
        private void HiddenAllPicsChecked_And_VisiblityThisCheched_PicChecked()
        {
            ...
            {
                listPics_PicChecked_6_And_8[0][(RavenTestIQTablePage.arrOfCorrectAnswersPics[RavenTestIQTablePage.ArrWrongSelectedUserAnswersByLevel[startPage]] - 1)].Visibility = Visibility.Visible;
                listPics_PicErrorChecked_6_And_8[0][(RavenTestIQTablePage.ListOfIncorrectlySelectedUserPics[startPage] - 1)].Visibility = Visibility.Visible;
            }
            else
            {
                listPics_PicChecked_6_And_8[1][(RavenTestIQTablePage.arrOfCorrectAnswersPics[RavenTestIQTablePage.ArrWrongSelectedUserAnswersByLevel[startPage]] - 1)].Visibility = Visibility.Visible;
                listPics_PicErrorChecked_6_And_8[1][(RavenTestIQTablePage.ListOfIncorrectlySelectedUserPics[startPage] - 1)].Visibility = Visibility.Visible;
            }
        }
        ...
        private void HiddenAllPicsChecked()
        {
            for (int i = 0; i < listPics_PicChecked_6_And_8.Count; i++)
            {
                for (int j = 0; j < listPics_PicChecked_6_And_8[i].Count; j++)
                {
                    ...
                    listPics_PicErrorChecked_6_And_8[i][j].Visibility = Visibility.Hidden;
                }
            }
        }
        ...
        private void InitializerAllArrayAllPics()
        {
            ...
            listPics_PicErrorChecked_6_And_8.Add(new List<Image> { PicErrorChecked_6_1, PicErrorChecked_6_2, PicErrorChecked_6_3, PicErrorChecked_6_4, PicErrorChecked_6_5, PicErrorChecked_6_6 });
            listPics_PicErrorChecked_6_And_8.Add(new List<Image> { PicErrorChecked_8_1, PicErrorChecked_8_2, PicErrorChecked_8_3, PicErrorChecked_8_4, PicErrorChecked_8_5, PicErrorChecked_8_6, PicErrorChecked_8_7, PicErrorChecked_8_8 });
